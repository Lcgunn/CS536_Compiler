...
abstract class DeclNode extends ASTnode {
    ...
    // default version of codeGen for tuple decls
    public void codeGen() { }
}
...
class FctnDeclNode extends DeclNode {
    ...
    public void codeGen() {
        ...
        Codegen.generate("subu", Codegen.SP, Codegen.SP, ((FctnSym)myId.sym()).getLocalsSize());
        // Body
        myBody.codeGen();
        // Exit
...
class IfStmtNode extends StmtNode {
    ...
    public void codeGen(){
        ...
        Codegen.generate(".data");
        String EndofConstruct = Codegen.nextLabel();
        myExp.codeGen();
        Codegen.genPop(Codegen.T0);
        Codegen.generate("beq", Codegen.T0, Codegen.FALSE, EndofConstruct);
        myDeclList.codeGen();
        myStmtList.codeGen();
        Codegen.genLabel(EndofConstruct);
    }
