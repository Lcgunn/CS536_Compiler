 ...
 * 
 * @author Beck Hasti, copyright 2014-2024
 */
public class P1_2 {
     ...
     * 
     * Note: testing DuplicateSymNameException happens in testInsert
     */
        ...
        try {
            ...
            try {
                ...
                error("SymTable.addDecl", 
                      "EmptySymTableException NOT thrown on empty SymTab");
            } catch (EmptySymTableException e) {
                // expected
            } catch (Exception e) {
                error("SymTable.addDecl", 
     ...
     * - also test lookupLocal in a SymTable with NO HashMap (should just return 
     *   null, no exception)
     *   
     * lookupGlobal: 
     * - both successful and failing lookups in a SymTable with just one 
        ...
        try { 
            ...
            for (int j=0; j<10; j++) {
                try {
                    ...
                    error("SymTable.addDecl", "DuplicateSymNameException for " +
            ...
            for (int j=0; j<10; j++) {
                ...
                try {
                    ...
                    error("SymTable.addDecl", 
                          "unexpected DuplicateSymNameException for add into " +
            ...
            for (int j=0; j<10; j++) {
                ...
                try {
                    ...
                    error("SymTable.addDecl", 
                          "unexpected DuplicateSymNameException for table with 2 " +
                          "HashMaps, new name");
                } catch (EmptySymTableException e) {
                    error("SymTable.addDecl", 
            ...
            for (int j=0; j<100; j++) {
                ...
                for (int k=0; k<20; k++) {
                    ...
                    try {
                        ...
                        error("SymTable.addDecl", 
                              "DuplicateSymNameException for table with many HashMaps");
                    } catch (EmptySymTableException e) {
                        error("SymTable.addDecl", 
